...
export async function POST({ request }) {
  ...
  const emailData = [
    {
      from: `"Best from SovietIO" <notify@mail.classroomio.com>`,
      to,
      subject: 'Welcome to SovietIO!',
      content: `
    <p>Dear ${name},</p>
      <p>My name is Best, the founder of SovietIO. I saw you signed up, any questions so far?</p>
      <p>
